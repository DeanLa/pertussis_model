...
logger.debug("*_" * 40)
logger.info(" " * 40 + "TIME{:10.2f}".format(clock() - clk))
# # Results
# RES *= omega_ap
...
Ii = y[3].sum(axis=0)
ax3.plot(x, new_cases(Ii, gamma_s), label="Data")
ax3.scatter(months, data_months, label="Data")
ax3.set_title("NEW SICK")

fig4, ax4 = plt.subplots()
logger.debug("SHAPES {} {}".format(x_old.shape, y_old[3].shape))
